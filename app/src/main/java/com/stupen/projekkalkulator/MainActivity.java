package com.stupen.projekkalkulator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonAdd, buttonMultiply, buttonSubs, buttonDivision, buttonPoint, buttonPercent, buttonDelete, buttonAnswer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDelete = findViewById(R.id.clear_btn);
        buttonAnswer = findViewById(R.id.answer_btn);
